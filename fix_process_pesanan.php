<?php
// Fix for process_pesanan.php to correctly update the pesanan_barang status
// This file contains the corrected process function

/**
 * This is the corrected function that should replace the existing one in process_pesanan.php
 * The main issues are:
 * 1. The status in pesanan_barang is not being updated correctly
 * 2. The bahan_baku entries are not being linked to the pesanan correctly
 */
function process_pesanan_fixed($conn, $id_pesanan) {
    // Begin transaction
...
/**
 * This function should be used to cancel a pesanan
 */
function cancel_pesanan_fixed($conn, $id_pesanan) {
    // Begin transaction
    mysqli_begin_transaction($conn);
