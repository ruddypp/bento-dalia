-- Fix untuk masalah integrasi sistem inventori
-- Script ini memperbaiki trigger yang menangani perubahan status pesanan saat bahan_baku diapprove

-- Drop existing trigger
DROP TRIGGER IF EXISTS `update_pesanan_after_bahan_baku_update`;

-- Create new trigger that uses id_pesanan field directly
DELIMITER $$
...
-- Create function to check if all bahan_baku from a pesanan are approved
