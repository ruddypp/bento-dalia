            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="form-group transition-all duration-200">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="harga_modal" name="harga_modal" min="0" step="1000" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200" value="<?= htmlspecialchars($harga_modal) ?>" readonly>
                    </div>
                </div>
                ...
                <div class="form-group transition-all duration-200">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="keuntungan" name="keuntungan" min="0" step="1000" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200" value="<?= htmlspecialchars($keuntungan) ?>" readonly>
                    </div>
                </div>
