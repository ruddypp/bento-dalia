        ...
        <form method="POST" action="<?= $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data" class="transition-all duration-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="form-group transition-all duration-200">
                    ...
                    <textarea id="bahan" name="bahan" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" required><?= htmlspecialchars($bahan) ?></textarea>
                    <p class="text-xs text-gray-500 mt-1">Pisahkan dengan koma, contoh: Kopi, Susu, Gula</p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="bg-blue-50 p-4 rounded-lg">
                        <div class="mb-4">
                            ...
                            <p class="text-xl font-bold text-blue-600">${menuPrice}</p>
                        </div>
                        <div class="mb-4">
